...
if (failed) existing.failed_runs += 1;
else existing.passed_runs += 1;
...
await fs.writeFile(badgePath, JSON.stringify(badge, null, 2) + '\n', 'utf-8');// console.log('[update-test-stats] Badge atualizado:', badge.message); // TODO: Remover antes da produção