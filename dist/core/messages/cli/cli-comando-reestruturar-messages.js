...
export const CliComandoReestruturarMessages = {
    ...
    fallbackProblemasEstruturais: (qtd) => `\n${qtd} problemas estruturais detectados para correção:`,
    fallbackLinhaOcorrencia: (tipo, rel, mensagem) => `- [${tipo}] ${rel}: ${mensagem}`,
    ...
    reestruturacaoConcluida: (qtd, frase) => `Reestruturação concluída: ${qtd} ${frase}.`,
