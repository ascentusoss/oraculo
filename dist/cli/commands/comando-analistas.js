    ...
    return new Command('analistas')
        ...
        try {
            ...
            if (opts.doc) {
                ...
                linhas.push('');
                linhas.push(CliComandoAnalistasMessages.docGeradoEm(new Date().toISOString()));
                linhas.push('');
                ...
                for (const a of lista) {
                    ...
                    linhas.push(CliComandoAnalistasMessages.docLinhaAnalista(a.nome, a.categoria, a.descricao || '', limitesStr));
                }
                linhas.push('');
            ...
            for (const a of lista) {
                log.info(CliComandoAnalistasMessages.linhaAnalista(a.nome, a.categoria, a.descricao));
            }
            log.info(CliComandoAnalistasMessages.tituloComIcone(ICONES_DIAGNOSTICO.info));
