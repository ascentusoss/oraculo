...
**Status atual:** `` funciona via integração central (`src/shared/helpers/analista-wrapper.ts`) e é coberto por testes (`tests/shared/suppressao.test.ts`, `tests/analistas/suppressao-e2e.test.ts`).
